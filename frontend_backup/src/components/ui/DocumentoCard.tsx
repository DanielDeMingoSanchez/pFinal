...
import { Card, CardContent, CardActions, Typography, Button, Box, Chip, Avatar, Tooltip, IconButton } from '@mui/material';
import { FaDownload, FaEye, FaRegStar, FaStar, FaCalendarAlt } from 'react-icons/fa';
